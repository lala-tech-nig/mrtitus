      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Crafting meaningful experiences, capturing memories, and empowering growth through education, digital innovation, and real estate.
          </p>
        ...
        >
          <img
            src="/profile.png"
            alt="Uduakobong Titus portrait"
            className="w-[320px] md:w-[460px] lg:w-[560px] h-auto object-cover"
          />
        </motion.div>
      </div>
    </section>
